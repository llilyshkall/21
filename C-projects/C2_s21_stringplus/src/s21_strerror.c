...
const int err = 132;
const char *s21_errno[] = {"No error information",
                           "Operation not permitted",
                           "No such file or directory",
                           "No such process",
                           "Interrupted system call",
...
#else
const int err = 1;
const char *s21_errno[] = {"NOT DEFINED"};
#endif

char *s21_strerror(int errnum) {
  static char result[BUFFER];
  if (errnum >= 0 && errnum < err) {
    s21_strcpy(result, s21_errno[errnum]);
  } else {
#if defined(__APPLE__)
