...
START_TEST(s21_to_float_55) {
  s21_decimal inp = {{0x1B66216C, 0xB7B49FFA, 0x7F582BCC, 0x000E0000}};
  float out;
  float res;
  unsigned char b[] = {169, 56, 179, 87};
  memcpy(&res, &b, 4);
  int error = s21_from_decimal_to_float(inp, &out);
  ck_assert_float_eq(out, res);
  ck_assert_int_eq(error, 0);
...
START_TEST(s21_to_float_110) {
  s21_decimal inp = {{0x84996E0F, 0x8AF0505D, 0x8D32979C, 0x000E0000}};
  float out;
  float res;
  unsigned char b[] = {206, 183, 198, 87};
  memcpy(&res, &b, 4);
  int error = s21_from_decimal_to_float(inp, &out);
  ck_assert_float_eq(out, res);
  ck_assert_int_eq(error, 0);
...
START_TEST(s21_to_float_112) {
  s21_decimal inp = {{0xF67A24C8, 0x3ED37B37, 0xD9B22474, 0x000F0000}};
  float out;
  float res;
  unsigned char b[] = {144, 26, 117, 86};
  memcpy(&res, &b, 4);
  int error = s21_from_decimal_to_float(inp, &out);
  ck_assert_float_eq(out, res);
  ck_assert_int_eq(error, 0);
...
START_TEST(s21_to_float_139) {
  s21_decimal inp = {{0xD0B5E72E, 0xE8D41CC0, 0x1F103F7D, 0x800F0000}};
  float out;
  float res;
  unsigned char b[] = {190, 229, 11, 213};
  memcpy(&res, &b, 4);
  int error = s21_from_decimal_to_float(inp, &out);
  ck_assert_float_eq(out, res);
  ck_assert_int_eq(error, 0);
...
START_TEST(s21_to_float_170) {
  s21_decimal inp = {{0x57D84204, 0xE28CDE3A, 0x751DD17A, 0x000F0000}};
  float out;
  float res;
  unsigned char b[] = {135, 220, 3, 86};
  memcpy(&res, &b, 4);
  int error = s21_from_decimal_to_float(inp, &out);
  ck_assert_float_eq(out, res);
  ck_assert_int_eq(error, 0);
...
START_TEST(s21_to_float_182) {
  s21_decimal inp = {{0xE4C411C7, 0x2D9589C8, 0x66D17D9A, 0x000E0000}};
  float out;
  float res;
  unsigned char b[] = {52, 180, 144, 87};
  memcpy(&res, &b, 4);
  int error = s21_from_decimal_to_float(inp, &out);
  ck_assert_float_eq(out, res);
  ck_assert_int_eq(error, 0);
...
START_TEST(s21_to_float_186) {
  s21_decimal inp = {{0xA000FCD4, 0xBFD22275, 0x8178B719, 0x000F0000}};
  float out;
  float res;
  unsigned char b[] = {162, 197, 17, 86};
  memcpy(&res, &b, 4);
  int error = s21_from_decimal_to_float(inp, &out);
  ck_assert_float_eq(out, res);
  ck_assert_int_eq(error, 0);
...
Suite *test_from_decimal_to_float(void) {
  ...
  tcase_add_test(tc, s21_to_float_55);
  ...
  tcase_add_test(tc, s21_to_float_110);
  tcase_add_test(tc, s21_to_float_111);
  tcase_add_test(tc, s21_to_float_112);
  ...
  tcase_add_test(tc, s21_to_float_139);
  ...
  tcase_add_test(tc, s21_to_float_170);
