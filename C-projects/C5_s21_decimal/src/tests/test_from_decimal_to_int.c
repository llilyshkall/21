...
START_TEST(s21_from_decimal_to_int_108) {
  int true_res = 1;
...
START_TEST(s21_from_decimal_to_int_109) {
  int true_res = 0;
...
Suite *test_from_decimal_to_int(void) {
  ...
  tcase_add_test(tc, s21_from_decimal_to_int_108);
  tcase_add_test(tc, s21_from_decimal_to_int_109);
