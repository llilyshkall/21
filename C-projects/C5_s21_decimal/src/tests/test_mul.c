...
START_TEST(s21_mul_1) {
  ...
  s21_decimal output;
  s21_decimal result = {{0xF3DBF3B8, 0x1AC4C297, 0x213F2780, 0x800A0000}};
...
START_TEST(s21_mul_4) {
  ...
  s21_decimal output;
  s21_decimal result = {{0x0F5F583C, 0xB945AFEC, 0x1DAC8C69, 0x00080000}};
  int s21_res = s21_mul(val1, val2, &output);
  for (int i = 0; i < 4; i++) ck_assert_int_eq(result.bits[i], output.bits[i]);
  ck_assert_int_eq(s21_res, true_res);
}
...
START_TEST(s21_mul_6) {
  ...
  s21_decimal output;
  s21_decimal result = {{0x2E8F2872, 0x413E6C47, 0x3C23D1B1, 0x000C0000}};
  int s21_res = s21_mul(val1, val2, &output);
  for (int i = 0; i < 4; i++) ck_assert_int_eq(result.bits[i], output.bits[i]);
  ck_assert_int_eq(s21_res, true_res);
}
...
START_TEST(s21_mul_21) {
  ...
  s21_decimal output;
  s21_decimal result = {{0x6401E3C6, 0xC161DCEC, 0x86ABD057, 0x80070000}};
  int s21_res = s21_mul(val1, val2, &output);
  for (int i = 0; i < 4; i++) ck_assert_int_eq(result.bits[i], output.bits[i]);
  ck_assert_int_eq(s21_res, true_res);
}
...
START_TEST(s21_mul_30) {
  ...
  s21_decimal output;
  s21_decimal result = {{0x04140BDE, 0x98219D6A, 0x457F8AFD, 0x800D0000}};
  int s21_res = s21_mul(val1, val2, &output);
  for (int i = 0; i < 4; i++) ck_assert_int_eq(result.bits[i], output.bits[i]);
  ck_assert_int_eq(s21_res, true_res);
}
...
START_TEST(s21_mul_34) {
  ...
  s21_decimal output;
  s21_decimal result = {{0xE9A7397C, 0x0CE266C9, 0x5AD09D03, 0x80020000}};
  int s21_res = s21_mul(val1, val2, &output);
  for (int i = 0; i < 4; i++) ck_assert_int_eq(result.bits[i], output.bits[i]);
  ck_assert_int_eq(s21_res, true_res);
}
...
START_TEST(s21_mul_39) {
  ...
  s21_decimal output;
  s21_decimal result = {{0xA0922C10, 0x44AA1F41, 0x89471355, 0x800A0000}};
  int s21_res = s21_mul(val1, val2, &output);
  for (int i = 0; i < 4; i++) ck_assert_int_eq(result.bits[i], output.bits[i]);
  ck_assert_int_eq(s21_res, true_res);
}
...
START_TEST(s21_mul_41) {
  ...
  s21_decimal output;
  s21_decimal result = {{0xF716606E, 0x78CC2CBC, 0x5DEE6185, 0x00150000}};
  int s21_res = s21_mul(val1, val2, &output);
  for (int i = 0; i < 4; i++) ck_assert_int_eq(result.bits[i], output.bits[i]);
  ck_assert_int_eq(s21_res, true_res);
}
...
START_TEST(s21_mul_47) {
  ...
  s21_decimal output;
  s21_decimal result = {{0x2569929E, 0xD666671E, 0x1B763908, 0x00020000}};
  int s21_res = s21_mul(val1, val2, &output);
  for (int i = 0; i < 4; i++) ck_assert_int_eq(result.bits[i], output.bits[i]);
  ck_assert_int_eq(s21_res, true_res);
}
...
START_TEST(s21_mul_51) {
  ...
  s21_decimal output;
  s21_decimal result = {{0xE7632150, 0xFE063DA5, 0x95210343, 0x80020000}};
  int s21_res = s21_mul(val1, val2, &output);
  for (int i = 0; i < 4; i++) ck_assert_int_eq(result.bits[i], output.bits[i]);
  ck_assert_int_eq(s21_res, true_res);
}
...
START_TEST(s21_mul_62) {
  ...
  s21_decimal output;
  s21_decimal result = {{0x5C42732A, 0x3026A63B, 0x2A830133, 0x800C0000}};
  int s21_res = s21_mul(val1, val2, &output);
  for (int i = 0; i < 4; i++) ck_assert_int_eq(result.bits[i], output.bits[i]);
  ck_assert_int_eq(s21_res, true_res);
}
...
START_TEST(s21_mul_72) {
  ...
  s21_decimal output;
  s21_decimal result = {{0xFBE10D0C, 0x0E215C17, 0x5DE65DC3, 0x00060000}};
  int s21_res = s21_mul(val1, val2, &output);
  for (int i = 0; i < 4; i++) ck_assert_int_eq(result.bits[i], output.bits[i]);
  ck_assert_int_eq(s21_res, true_res);
}
...
START_TEST(s21_mul_75) {
  ...
  s21_decimal output;
  s21_decimal result = {{0x49F5B11E, 0x4CCBE659, 0x8C9F7817, 0x000B0000}};
  int s21_res = s21_mul(val1, val2, &output);
  for (int i = 0; i < 4; i++) ck_assert_int_eq(result.bits[i], output.bits[i]);
  ck_assert_int_eq(s21_res, true_res);
}
...
START_TEST(s21_mul_90) {
  ...
  s21_decimal output;
  s21_decimal result = {{0x4FFB6B1A, 0x396B0CB9, 0x5440CDF4, 0x80060000}};
  int s21_res = s21_mul(val1, val2, &output);
  for (int i = 0; i < 4; i++) ck_assert_int_eq(result.bits[i], output.bits[i]);
  ck_assert_int_eq(s21_res, true_res);
}
...
START_TEST(s21_mul_99) {
  ...
  s21_decimal output;
  s21_decimal result = {{0xE697D328, 0xF622D130, 0x32166BC5, 0x00040000}};
  int s21_res = s21_mul(val1, val2, &output);
  for (int i = 0; i < 4; i++) ck_assert_int_eq(result.bits[i], output.bits[i]);
  ck_assert_int_eq(s21_res, true_res);
}
...
START_TEST(s21_mul_100) {
  ...
  s21_decimal output;
  s21_decimal result = {{0x90EB06AC, 0xA49F282A, 0x4D12F56B, 0x00140000}};
  int s21_res = s21_mul(val1, val2, &output);
  for (int i = 0; i < 4; i++) ck_assert_int_eq(result.bits[i], output.bits[i]);
  ck_assert_int_eq(s21_res, true_res);
}
